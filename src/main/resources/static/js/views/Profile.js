...
<!--                                                 vvvv Used to identify modal by post ID. (Will be removed later)-->
                                            ...
                                            <!--      todo: get better name-->
                                                  ...
                                                  <textarea class="inputFields " placeholder="" name="description" id="description-${post.id}" required></textarea>
                                                  <br>
                                            ...
                                            <!--     todo possible calender integration -->
                                                  ...
                                                  <input class="inputFields" placeholder="yyyy-mm-dd" name="date" id="expiryDate-${post.id}" required>
                                                  <br>
                                                   <label for="quantity"><b>Edit Quantity:</b></label>
                                                  <input class="inputFields" placeholder="Enter the number available" name="quantity" id="quantity-${post.id}" required>
                                                  <br>
                                                  </div>
...
//                                                    <label for="photo"><b>Edit Photo:</b></label>
//                                                  <!--  vvvv Will eventually need to be changed to Post img. Maybe inside a div with these props (id="photo-post.id">post.photo<) Using Jquery-->
//                                                   <input class="inputFields" placeholder="this will be change later" name="photo" id="photo"  required>
//                                                   <br>
//                                             <!--     todo possible calender integration -->
//                                                    <label for="date"><b>Edit Expiration Date:</b></label>
//                                                   <input class="inputFields" placeholder="yyyy-mm-dd" name="date" id="expiryDate-${post.id}"  required>
