...
VALUES (3, 'Asparagus', 'Totally not rotten', 'test', '22:06:30', 15 , 'open'),
       (2, 'Cream of Mushroom Soup', 'Still in can', 'test', '22:06:29', 1, 'closed'),
       (2, 'Macaroni and Cheese', 'Homemade and delicious', 'test', '22:06:10', 5, 'open'),
       ...
       (1, 'KFC Chicken', 'It''s finger linkin'' good.', 'photo of chicken(dead and cooked/ready to eat)', '22:12:25', 8, 'open'),
